...
public class ExprMineCoreCreatedRequestProperty extends SimpleExpression<Object> {
    ...
    protected Object[] get(Event event) {
        ...
        Object value =
                switch (property) {
                    case 0 -> request.getId();
                    case 1 -> request.getService();
                    case 2 -> request.getStatus() == null ? null : request.getStatus().getServer();
                    case 3 -> request.getStatus() == null ? null : request.getStatus().getClient();
                    case 4 -> request.getCreatedAt();
                    case 5 -> request.getUpdatedAt();
                    default -> null;
                };
